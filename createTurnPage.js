(function (dom) {
    dom.prototype.createTurnPage = createTurnPage;
    ...
    function autoMove(direction) {
        ...
        if (oWrapper.lock) {
            ...
            if (!direction || direction == 'left->right') {
                ...
                startMove(oWrapper.sliderPage, {
                    left: oWrapper.sliderPage.offsetLeft - this.moveWidth
                }, function () {
                ...
                oWrapper.changeIndex(oWrapper.index);
                startMove(oWrapper.sliderPage, {
                    left: oWrapper.sliderPage.offsetLeft + oWrapper.moveWidth
                }, function () {
                    oWrapper.lock = true;
                    oWrapper.timer = setTimeout(autoMove.bind(oWrapper), 3500);
                    // oWrapper.timer = setTimeout(oWrapper.autoMove, 3500);
        ...
        for (var i = 0; i < oWrapper.num; i++) {
            (function (myIndex) {
                oWrapper.oSpanArray[myIndex].onclick = function () {
                    ...
                    oWrapper.changeIndex(oWrapper.index);
                    startMove(oWrapper.sliderPage, {
                        left: -oWrapper.moveWidth * oWrapper.index
                    }, function () {
                        oWrapper.lock = true;
                        oWrapper.timer = setTimeout(autoMove.bind(oWrapper), 3500);
                    })
